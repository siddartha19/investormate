...
@patch("investormate.analysis.earnings.get_yfinance_calendar_data")
@patch("investormate.analysis.earnings.get_yfinance_data")
...
@patch("investormate.analysis.earnings.get_yfinance_earnings_history")
...
@patch("investormate.analysis.earnings.get_yfinance_revenue_estimate")
@patch("investormate.analysis.earnings.get_yfinance_earnings_estimate")
...
@patch("investormate.analysis.earnings.get_yfinance_eps_trend")
...
@patch("investormate.analysis.earnings.get_yfinance_growth_estimates")
