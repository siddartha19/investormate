...
value_stocks = screener.value_stocks(pe_max=15, pb_max=1.5, debt_to_equity_max=50)
print(f"Value stocks found: {value_stocks}")

# Find growth stocks
print("\nFinding growth stocks...")
growth_stocks = screener.growth_stocks(revenue_growth_min=20, eps_growth_min=15)
print(f"Growth stocks found: {growth_stocks}")

# Find dividend stocks
print("\nFinding dividend stocks...")
dividend_stocks = screener.dividend_stocks(yield_min=3.0, payout_ratio_max=60)
