...
result_openai = investor.ask("AAPL", "What's the current valuation?", provider="openai")
...
if "anthropic" in investor.available_providers:
    ...
    result_anthropic = investor.ask(
        "AAPL", "What's the current valuation?", provider="anthropic"
    )
...
if "gemini" in investor.available_providers:
    ...
    result_gemini = investor.ask(
        "AAPL", "What's the current valuation?", provider="gemini"
    )
