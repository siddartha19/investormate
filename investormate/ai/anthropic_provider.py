...
class AnthropicProvider(AIProvider):
    ...
    def __init__(self, api_key: str, model: Optional[str] = None, **kwargs):
        ...
        super().__init__(api_key, model or "claude-3-5-sonnet-20241022", **kwargs)
    ...
    def analyze(
        ...
        try:
            ...
            # Anthropic requires max_tokens; default to 4096 when unset
            request_kwargs = {
                "model": self.model,
                ...
                "system": (
                    system_prompt
                    if system_prompt
                    else "You are a helpful financial analyst assistant."
                ),
